  ...
  return (
    <Section>
      ...
      <blockquote style={decimaBold} className="text-center" cite="ademe">
        ...
        réaliser le geste de déconsignation. Alors que le pouvoir d’achat est
        l’une des principales préoccupations des Français aujourd’hui, le
        système de la consigne ne fait l’objet d’aucun rejet d’ordre financier.
        Spontanément, les Français estiment que ce système aurait un impact
        neutre sur leur pouvoir d’achat voire même positif.
      </blockquote>
