    ...
    <div class="mt-5 md:mt-20 grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-12">
      ...
      <div>
        ...
        <div>
          ...
          collectivités et les consommateurs (qui paye une éco-taxe via le
          ...
          l’enfouissement 106€/t Ce cout est répercuté pour les consomateurs sur
          les prix des produits et payé doublement via la taxe d’ordures
          ménagères.
          <p>
            <a
              class="underline"
            ...
            >
              Le recyclage du plastique, c’est pas fan- tastique ! [Vidéo France
              4]
            </a>
          </p>
        </div>
