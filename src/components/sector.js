...
const Sector = () => (
  <Section>
    ...
    <div class="mt-2 md:mt-5 md:px-20 text-center">
      ...
      alimentaires (bouteilles, bocaux...) dans les Bouches-du-Rhône et en
      Vaucluse, et de proposer ainsi une alternative aux emballages à usage
      unique et très souvent en plastique. Cela se traduit par la mise en place
      d’infrastructures de collecte et de lavage d’emballages à une échelle
      locale.
    </div>
    <div class="mt-2 md:mt-5 md:px-20 text-center">
